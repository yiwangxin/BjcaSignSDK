#
#  Be sure to run `pod spec lint BjcaSignSDK.podspec' to ensure this is a
...
s.license      = { :type => "MIT", :file => "FILE_LICENSE" }
  ...
  s.author             = { "wuxing" => "wuxing@bjca.org.cn" }
  # Or just: s.author    = "wuxing"
  # s.authors            = { "wuxing" => "wuxing@bjca.org.cn" }
  # s.social_media_url   = "http://twitter.com/wuxing"
...
#s.source       = { :git => "http://EXAMPLE/BjcaSignSDK.git", :tag => "#{s.version}" }
